...
(function () {
  ...
  const TL = QUERIES.map((q, i) => { const R0 = .04 + i * .05, V0 = .23 + i * .07; return { R0, R1: R0 + .10, T0: R0 + .04, T1: R0 + .16, V0, V1: V0 + .17 }; });
  const OPS = [[.40, .48], [.47, .56], [.54, .69]];         // σ, ⋈, γ windows on the panel
